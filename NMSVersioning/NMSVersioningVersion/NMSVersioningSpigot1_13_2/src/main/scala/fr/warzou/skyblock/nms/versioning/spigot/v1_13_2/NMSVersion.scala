package fr.warzou.skyblock.nms.versioning.spigot.v1_13_2
...
import fr.warzou.skyblock.nms.versioning.spigot.v1_13_2.world.NMSWorld
...
class NMSVersion extends api.NMSVersion {
  ...
  override def enumerateEntities(adapter: AdapterAPI, cuboid: Cuboid): List[_] = {
    ...
    val entityList: java.util.List[net.minecraft.server.v1_13_R2.Entity] = cuboid.minCorner(adapter).world.map(Bukkit.getWorld).getOrElse(Bukkit.getWorlds.get(0))
      .asInstanceOf[CraftWorld].getHandle.getEntities(null, bb, (_: net.minecraft.server.v1_13_R2.Entity) => true)
